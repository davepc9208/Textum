...
const values = [
  {
    ...
    label: 'Rigor Académico',
    desc: 'Cada corrección y cada recomendación están fundamentadas en criterios académicos sólidos y contrastados.',
  },
  {
    icon: ShieldIcon,
    label: 'Confianza',
    desc: 'Relación de trabajo basada en la confidencialidad absoluta y el respeto hacia tu proceso creativo.',
  },
  {
    icon: StarIcon,
    label: 'Excelencia',
    desc: 'Búsqueda constante del más alto nivel en cada servicio, sin concesiones en la calidad del resultado.',
  },
  {
    icon: HeartIcon,
    label: 'Integridad',
    desc: 'Feedback honesto y constructivo. Siempre verdad, siempre con el objetivo de tu crecimiento real.',
  },
];
...
function ShieldIcon() {
  return <Shield size={28} className="text-gold" strokeWidth={1.5} />;
}
function StarIcon() {
  return <Star size={28} className="text-gold" strokeWidth={1.5} />;
}
function HeartIcon() {
  return <Heart size={28} className="text-gold" strokeWidth={1.5} />;
}
    ...
    <section id="valores" className="section-cream py-28 px-6 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16 reveal">
          <p className="text-xs tracking-[0.3em] text-gold uppercase mb-4">Fundamentos</p>
          <h2 className="font-serif text-5xl md:text-6xl font-light text-navy leading-tight">
            Nuestros <em className="not-italic text-gold-gradient">valores</em>
          </h2>
        </div>
        ...
        <div className="mt-20 reveal text-center max-w-2xl mx-auto">
          <div className="glass-cream rounded-sm p-10 shadow-xl border border-gold/10">
            ...
            <p className="font-serif italic text-2xl text-navy/80 leading-relaxed font-light">
              "La escritura no es un talento innato, es una habilidad que se aprende, se practica y se perfecciona."
            </p>
